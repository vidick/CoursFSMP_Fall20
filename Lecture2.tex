...
\begin{exercise}\label{ex:approx-qubit}
Say that $(\ket{\psi},X,Z)$ is an $\eps$-approximate qubit if $\|\{X,Z\}\ket{\psi}\|\leq \eps$. Show that there is an isometry $V: \mH \to \C^2 \otimes \mH'$ such that for $W\in \{X,Z\}$, 
\[ \big\|\big( W - V^\dagger (\sigma_W \otimes \Id )V \big)\ket{\psi}\big\|^2 \,\leq\, O({\eps})\;.\] 
